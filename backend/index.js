...
//削除してから
const deleteRow = (no, year, month, id) => {
    connection.query(
...
for (let sysNumber = 1; sysNumber < 5; sysNumber++) {
    for (let year = 2021; year < 2024; year++) {
        for (let month = 1; month < 13; month++) {
            ...
            app.get(`/api_${sysNumber}_${year}_${month}`, (req, res) => {
                    ...
                    (error, results) => {
                        ...
                        if (results != null) {
                            ...
                            for (let i = 0; i < results.length; i++) {
                                ...
                                tDimeArray[i][4] = results[i].day1;
                                tDimeArray[i][5] = results[i].day2;
                                tDimeArray[i][6] = results[i].day3;
                                tDimeArray[i][7] = results[i].day4;
                                tDimeArray[i][8] = results[i].day5;
                                tDimeArray[i][9] = results[i].day6;
                                tDimeArray[i][10] = results[i].day7;
                                tDimeArray[i][11] = results[i].day8;
                                tDimeArray[i][12] = results[i].day9;
                                tDimeArray[i][13] = results[i].day10;
                                tDimeArray[i][14] = results[i].day11;
                                tDimeArray[i][15] = results[i].day12;
                                tDimeArray[i][16] = results[i].day13;
                                tDimeArray[i][17] = results[i].day14;
                                tDimeArray[i][18] = results[i].day15;
                                tDimeArray[i][19] = results[i].day16;
                                tDimeArray[i][20] = results[i].day17;
                                tDimeArray[i][21] = results[i].day18;
                                tDimeArray[i][22] = results[i].day19;
                                tDimeArray[i][23] = results[i].day20;
                                tDimeArray[i][24] = results[i].day21;
                                tDimeArray[i][25] = results[i].day22;
                                tDimeArray[i][26] = results[i].day23;
                                tDimeArray[i][27] = results[i].day24;
                                tDimeArray[i][28] = results[i].day25;
                                tDimeArray[i][29] = results[i].day26;
                                tDimeArray[i][30] = results[i].day27;
                                tDimeArray[i][31] = results[i].day28;
                                tDimeArray[i][32] = results[i].day29;
                                tDimeArray[i][33] = results[i].day30;
                                tDimeArray[i][34] = results[i].day31;
                            }
...
for (let sysNumber = 1; sysNumber < 5; sysNumber++) {
    for (let year = 2021; year < 2024; year++) {
        for (let month = 1; month < 13; month++) {
            ...
            app.get(`/tableRate_${sysNumber}_${year}_${month}`, (req, res) => {
